...
*/
const $ = new Env('东东萌宠');
let cookiesArr = [], cookie = '', jdPetShareArr = [], isBox = false, notify, newShareCodes, allMessage = 'MTE1NDUyMjEwMDAwMDAwNDE2Nzc2ODk=@MTE0MDQ3MzIwMDAwMDAwNDkxNDM5ODc=';
...
'MTE1NDUyMjEwMDAwMDAwNDE2Nzc2ODk=@MTE0MDQ3MzIwMDAwMDAwNDkxNDM5ODc=',
  //账号二的好友shareCode,不同好友的shareCode中间用@符号隔开 'MTE1NDUyMjEwMDAwMDAwNDE2Nzc2ODk=@MTE0MDQ3MzIwMDAwMDAwNDkxNDM5ODc=',
]
